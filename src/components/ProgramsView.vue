<template>
  <div>
    ...
    <div class="list">
      <div class="card col-12 col-sm-6 col-md-4 b-col-lg-3 col-xl-3" v-for="channel in programView"
...
export default {
  ...
  methods: {
    ...
    changeDataInPL (key, date) {
      console.log('changeDataInPL', key, date);
    ...
    changeTimeInPL (time) {
      console.log('changeTimeInPL', time);
